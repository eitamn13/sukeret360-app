...
export const FEMALE_THEME: Theme = {
  ...
  primaryDark: '#9D2F61',
  primaryLight: '#F472B6',
  primaryBorder: '#F6D5E3',
  primaryBg: '#FFF5F9',
  primaryShadow: 'rgba(194,65,122,0.18)',
  primaryMuted: '#9A6C84',
  gradientCard: 'linear-gradient(135deg, #F472B6 0%, #DB2777 52%, #9D174D 100%)',
  gradientFull: 'linear-gradient(180deg, #FFF9FC 0%, #FFF1F6 55%, #FFF8FB 100%)',
  headerBg: 'rgba(255,249,252,0.94)',
  headerBorder: '#F7E1EA',
...
export const MALE_THEME: Theme = {
  ...
  primaryDark: '#1E3A8A',
  primaryLight: '#38BDF8',
  primaryBorder: '#D5E3FF',
  primaryBg: '#F3F7FF',
  primaryShadow: 'rgba(29,78,216,0.18)',
  primaryMuted: '#6C83B8',
  gradientCard: 'linear-gradient(135deg, #38BDF8 0%, #2563EB 48%, #1E3A8A 100%)',
  gradientFull: 'linear-gradient(180deg, #F8FBFF 0%, #EEF4FF 55%, #F6FAFF 100%)',
